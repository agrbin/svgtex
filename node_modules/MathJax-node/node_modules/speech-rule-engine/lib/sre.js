...
"[p] (pause:200);","self::punct");(0,sre.SemanticTreeRules.defineRule_)("omit-empty","default.default","","self::empty");(0,sre.SemanticTreeRules.defineRule_)("fences-open-close","default.default",'[p] (pause:100); [t] "open"; [n] children/*[1]; [p] (pause:200);[t] "close"',"self::fenced",'@role="leftright"');(0,sre.SemanticTreeRules.defineRule_)("fences-open-close-in-appl","default.default","[p] (pause:100); [n] children/*[1]; [p] (pause:200);",'self::fenced[@role="leftright"]',"./parent::children/parent::appl");
...
sre.SemanticTree.prototype.processMultiScript_=function(a){if(!a.length)return this.makeEmptyNode_();var b=this.parseMathml_(a.shift());if(!a.length)return b;for(var c=[],d=[],e=[],f=[],g=!1,h=0,k=0,l;l=a[k];k++)"MPRESCRIPTS"===sre.SemanticUtil.tagName(l)?(g=!0,h=0):(g?h&1?c.push(l):d.push(l):h&1?e.push(l):f.push(l),h++);if(!sre.SemanticUtil.purgeNodes(c).length&&!sre.SemanticUtil.purgeNodes(d).length){e=sre.SemanticUtil.purgeNodes(e);f=sre.SemanticUtil.purgeNodes(f);if(!e.length&&!f.length)return b;
a=f.length?e.length?"MSUBSUP":"MSUB":"MSUP";b=[b];f.length&&b.push(this.processRow_(this.parseMathmlChildren_(f)));e.length&&b.push(this.processRow_(this.parseMathmlChildren_(e)));return this.makeLimitNode_(a,b)}return this.makeBranchNode_(sre.SemanticAttr.Type.TENSOR,[b,this.makeScriptNode_(d,sre.SemanticAttr.Role.LEFTSUB),this.makeScriptNode_(c,sre.SemanticAttr.Role.LEFTSUPER),this.makeScriptNode_(f,sre.SemanticAttr.Role.RIGHTSUB),this.makeScriptNode_(e,sre.SemanticAttr.Role.RIGHTSUPER)],[])};
sre.SemanticTree.prototype.makeScriptNode_=function(a,b){switch(a.length){case 0:var c=this.makeEmptyNode_();break;case 1:c=this.parseMathml_(a[0]);break;default:c=this.makeDummyNode_(this.parseMathmlChildren_(a))}c.role=b;return c};sre.MathspeakUtil={};sre.MathspeakUtil.spaceoutText=function(a){return a.textContent.split("").join(" ")};sre.MathspeakUtil.spaceoutNumber=function(a){a=a.textContent.split("");for(var b=[],c=new sre.SystemExternal.xmldom.DOMParser,d=0,e;e=a[d];d++){var f=sre.SemanticAttr.Type.NUMBER,g=e.match(/\W/)?sre.SemanticAttr.Role.UNKNOWN:sre.SemanticAttr.Role.PROTECTED;e=c.parseFromString("<"+f+' role="'+g+'">'+e+"</"+f+">");b.push(e.documentElement)}return b};
sre.MathspeakUtil.spaceoutIdentifier=function(a){if(!a.textContent.match(/[a-zA-Z]+/))return a.setAttribute("role",sre.SemanticAttr.Role.PROTECTED),[a];a=a.textContent.split("");for(var b=[],c=new sre.SystemExternal.xmldom.DOMParser,d=0,e;e=a[d];d++){var f=sre.SemanticAttr.Type.IDENTIFIER;e=c.parseFromString("<"+f+' role="'+sre.SemanticAttr.Role.UNKNOWN+'">'+e+"</"+f+">");b.push(e.documentElement)}return b};
